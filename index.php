...
<div class="col-lg-12 col-md-12 col-sm-12 gulfBlueBG mx-0 px-5 bg-gradient">
	 <section class="col-lg-6 col-md-8 col-sm-12 mt-0 mx-auto py-5 gulfBlueBG bg-gradient">
        ...
        <p class="lead text-white">We're a Texas-based <a href="https://www.charitynavigator.org/ein/811313299">501(c)(3) organization</a> offering solutions and opportunities to engage underserved teens in staying on the path to their success.</p>
