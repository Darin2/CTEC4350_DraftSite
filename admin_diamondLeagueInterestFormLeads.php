...
//If they do have admin access, print each record from the diamondLeagueInterestFormSubmissions table (will style the page to look better later)
  ...
  $sql = "SELECT diamondLeagueInterestID, diamondLeagueFirstName, diamondLeagueLastName, diamondLeagueEmail, diamondLeaguePhoneNumber, diamondLeagueMessage FROM `diamondLeagueInterestFormSubmissions`";
	...
	if ($stmt->prepare($sql)){
		...
		$stmt->bind_result($diamondLeagueInterestID, $diamondLeagueFirstName, $diamondLeagueLastName, $diamondLeagueEmail, $diamondLeaguePhoneNumber, $diamondLeagueMessage);
    ...
    $rowcounter=1;
      ...
      //This will take some polishing to make it actually look nice
        ...
        <th scope='row'>$rowcounter</th>
          <td>$diamondLeagueFirstName</a></td>
          <td>$diamondLeagueLastName</td>
          <td>$diamondLeagueEmail</td>
          <td>$diamondLeaguePhoneNumber</td>
          <td>$diamondLeagueMessage</td>
        </tr>";
    ...
    <h1 class='display-4 text-white py-4 my-4'>Diamond League Leads</h1>
    </div>
